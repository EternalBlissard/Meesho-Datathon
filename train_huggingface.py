...
model_name = f'./vit2/{category}/final'
...
train_fashion_data = CustomFashionManager(csv_file=train_df,root_dir='cropped_images')
val_fashion_data = CustomFashionManager(csv_file=val_df,root_dir='cropped_images')
...
# model = MultiLabelMultiClassViT.from_pretrained(model_name,config=config,attn_implementation="eager")
