...
model_name = f'../models/{category}_EffAttr8/final'
...
model = MultiLabelMultiClassEff.from_pretrained(model_name)
...
test_df.to_csv(f"../preds/{category}_EffAttr8.csv",index=False)
